...
public class CactusParser extends Parser {
	...
	public final TokenContext token() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << COMMENT) | (1L << KEYWORDS) | (1L << ID) | (1L << CONST) | (1L << OPERATOR) | (1L << WHITESPACE))) != 0)) {
				{
				{
				setState(2);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << COMMENT) | (1L << KEYWORDS) | (1L << ID) | (1L << CONST) | (1L << OPERATOR) | (1L << WHITESPACE))) != 0)) ) {
	...
	public static final String _serializedATN =
		...
		"\2\6\n\2\f\2\16\2\t\13\2\3\2\2\2\3\2\2\3\5\2\3\4\16\20%%\2\n\2\7\3\2\2"+
		"\2\4\6\t\2\2\2\5\4\3\2\2\2\6\t\3\2\2\2\7\5\3\2\2\2\7\b\3\2\2\2\b\3\3\2"+
		"\2\2\t\7\3\2\2\2\3\7";
